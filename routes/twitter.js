...
module.exports ={
	query: function(req,res){
		client.get('search/tweets', {q:req.params.query, from:'breakingnews OR bbcbreaking OR AP+BREAKING OR ReutersLive OR AJELive OR AFP+#BREAKING', count:100}, function(err, data, response) {
	...
	latest: function(req,res) {
		client.get('search/tweets', {q:'', from:'breakingnews OR bbcbreaking OR AP+BREAKING OR ReutersLive OR AJELive OR AFP+#BREAKING', count:100}, function(err, data, response) {
